...
import ru.stersh.hronos.feature.project.list.databinding.FragmentProjectsBinding
import ru.stersh.hronos.feature.project.list.navigation.ProjectListNavigation
import ru.stersh.hronos.feature.project.list.ui.adapter.ProjectsAdapter
...
class ProjectsFragment : Fragment() {
    ...
    private val projectListNavigation by inject<ProjectListNavigation>()
    ...
    private fun showAddProjectButton() {
        ...
        binding.projectAddBtn.setOnClickListener {
            projectListNavigation.openProjectEditor(parentFragmentManager)
        }
    }
